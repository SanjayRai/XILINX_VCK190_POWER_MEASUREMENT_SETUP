...
################################################################
# This is a generated script based on design: bd_6ca1
#
...
proc create_hier_cell_hier_nsw { parentCell nameHier } {
  ...
  # Create instance: M02_AXI_nsw, and set properties
  set M02_AXI_nsw [ create_bd_cell -type ip -vlnv xilinx.com:ip:noc_nsw:1.0 M02_AXI_nsw ]
  set_property -dict [ list \
   CONFIG.NSW_MODE {SW_Slave} \
   CONFIG.NSW_NUM_PATHS {1} \
   CONFIG.NSW_PATH_TYPE {RDWR} \
  ...
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_cells /hier_nsw/M02_AXI_nsw]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_cells /hier_nsw/M02_AXI_nsw]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_CELL {true} [get_bd_cells /hier_nsw/M02_AXI_nsw]
  ...
  connect_bd_intf_net -intf_net S00_AXI_nsw_M00_INCMM [get_bd_intf_pins MC0_nsw/S02_INCMM] [get_bd_intf_pins S00_AXI_nsw/M00_INCMM]
  ...
  connect_bd_intf_net -intf_net S00_AXI_nsw_M01_INCMM [get_bd_intf_pins M00_AXI_nsw/S00_INCMM] [get_bd_intf_pins S00_AXI_nsw/M01_INCMM]
  ...
  connect_bd_intf_net -intf_net S01_AXI_nsw_M00_INCMM [get_bd_intf_pins MC0_nsw/S04_INCMM] [get_bd_intf_pins S01_AXI_nsw/M00_INCMM]
  ...
  connect_bd_intf_net -intf_net S02_AXI_nsw_M00_INCMM [get_bd_intf_pins MC0_nsw/S03_INCMM] [get_bd_intf_pins S02_AXI_nsw/M00_INCMM]
  ...
  connect_bd_intf_net -intf_net S02_AXI_nsw_M01_INCMM [get_bd_intf_pins M01_AXI_nsw/S00_INCMM] [get_bd_intf_pins S02_AXI_nsw/M01_INCMM]
  ...
  connect_bd_intf_net -intf_net S02_AXI_nsw_M02_INCMM [get_bd_intf_pins M02_AXI_nsw/S00_INCMM] [get_bd_intf_pins S02_AXI_nsw/M02_INCMM]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_intf_nets S02_AXI_nsw_M02_INCMM]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_intf_nets S02_AXI_nsw_M02_INCMM]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_intf_nets S02_AXI_nsw_M02_INCMM]
  connect_bd_intf_net -intf_net S03_AXI_nsw_M00_INCMM [get_bd_intf_pins MC0_nsw/S05_INCMM] [get_bd_intf_pins S03_AXI_nsw/M00_INCMM]
  ...
  connect_bd_intf_net -intf_net S04_AXI_nsw_M00_INCMM [get_bd_intf_pins MC0_nsw/S01_INCMM] [get_bd_intf_pins S04_AXI_nsw/M00_INCMM]
  ...
  connect_bd_intf_net -intf_net S05_AXI_nsw_M00_INCMM [get_bd_intf_pins MC0_nsw/S00_INCMM] [get_bd_intf_pins S05_AXI_nsw/M00_INCMM]
  ...
  connect_bd_net -net M00_AXI_nsw_NSU [get_bd_pins NSU1] [get_bd_pins M00_AXI_nsw/NSU]
  ...
  connect_bd_net -net M01_AXI_nsw_NSU [get_bd_pins NSU2] [get_bd_pins M01_AXI_nsw/NSU]
  ...
  connect_bd_net -net M02_AXI_nsw_NSU [get_bd_pins NSU3] [get_bd_pins M02_AXI_nsw/NSU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets M02_AXI_nsw_NSU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets M02_AXI_nsw_NSU]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets M02_AXI_nsw_NSU]
  ...
  connect_bd_net -net S00_AXI_nmu_NMU [get_bd_pins NMU2] [get_bd_pins S00_AXI_nsw/NMU]
  ...
  connect_bd_net -net S01_AXI_rpu_NMU [get_bd_pins NMU4] [get_bd_pins S01_AXI_nsw/NMU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets S01_AXI_rpu_NMU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets S01_AXI_rpu_NMU]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets S01_AXI_rpu_NMU]
  connect_bd_net -net S02_AXI_nmu_NMU [get_bd_pins NMU3] [get_bd_pins S02_AXI_nsw/NMU]
  ...
  connect_bd_net -net S04_AXI_nmu_NMU [get_bd_pins NMU1] [get_bd_pins S04_AXI_nsw/NMU]
  ...
  connect_bd_net -net S05_AXI_nmu_NMU [get_bd_pins NMU] [get_bd_pins S05_AXI_nsw/NMU]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CONNECTIONS {MC_0 { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M01_AXI { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}}  M02_AXI {read_bw {5} write_bw {5}}} \
   CONFIG.DATA_WIDTH {128} \
   CONFIG.DEST_IDS {M01_AXI:0x40:M02_AXI:0x80} \
   ] $S02_AXI
  ...
  set_property -dict [ list \
   ...
   CONFIG.USER_PHYS_NAME {NOC_NSU512_X0Y2} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.USER_NOC_CATEGORY {PL} \
   CONFIG.USER_NOC_NSU_WIDTH {512} \
   CONFIG.USER_PHYS_NAME {NOC_NSU512_X0Y1} \
   CONFIG.USER_REG_AXI_LOOPBACK {0x0} \
   CONFIG.USER_REG_COMP_ID_INDEX0 {0x00} \
   CONFIG.USER_REG_COMP_ID_INDEX1 {0x01} \
   CONFIG.USER_REG_COMP_ID_MODE {0x0} \
  ...
  # Create instance: M02_AXI_nsu, and set properties
  set M02_AXI_nsu [ create_bd_cell -type ip -vlnv xilinx.com:ip:noc_nsu:1.0 M02_AXI_nsu ]
  set_property -dict [ list \
   CONFIG.ATTR_FILE {nocattrs.dat} \
   CONFIG.NOC_FREQ {1000} \
   CONFIG.USER_NOC_CATEGORY {PL} \
  ...
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_cells M02_AXI_nsu]
  ...
  set_property -dict [ list \
   ...
   CONFIG.USER_REG_ADDR_MASK0 {0xffffffe0} \
   ...
   CONFIG.USER_REG_DDR_DST_MAP0 {0x240} \
   ...
   CONFIG.USER_REG_RD_VCA_TOKEN0 {0x2B} \
  ...
  # Create instance: S01_AXI_rpu, and set properties
  set S01_AXI_rpu [ create_bd_cell -type ip -vlnv xilinx.com:ip:noc_nmu:1.0 S01_AXI_rpu ]
  set_property -dict [ list \
   CONFIG.ATTR_FILE {nocattrs.dat} \
   CONFIG.NOC_FREQ {1000} \
   CONFIG.USER_NOC_CATEGORY {PS} \
  ...
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_cells S01_AXI_rpu]
  ...
  set_property -dict [ list \
   ...
   CONFIG.USER_REG_ADDR_DST0 {0x0040} \
   CONFIG.USER_REG_ADDR_DST1 {0x0080} \
   CONFIG.USER_REG_ADDR_DST2 {0x0000} \
   CONFIG.USER_REG_ADDR_DST3 {0x0000} \
   CONFIG.USER_REG_ADDR_DST4 {0x0000} \
   CONFIG.USER_REG_ADDR_DST5 {0x0000} \
   ...
   CONFIG.USER_REG_ADDR_DST14 {0x0000} \
   CONFIG.USER_REG_ADDR_DST15 {0x0000} \
   CONFIG.USER_REG_ADDR_ENABLE {0x0003} \
   CONFIG.USER_REG_ADDR_MADDR0 {0x02014000} \
   CONFIG.USER_REG_ADDR_MADDR1 {0x0201c000} \
   CONFIG.USER_REG_ADDR_MADDR2 {0x00000000} \
   CONFIG.USER_REG_ADDR_MADDR3 {0x00000000} \
   CONFIG.USER_REG_ADDR_MADDR4 {0x00000000} \
   CONFIG.USER_REG_ADDR_MADDR5 {0x00000000} \
   ...
   CONFIG.USER_REG_ADDR_MASK1 {0xffffffff} \
   CONFIG.USER_REG_ADDR_MASK2 {0x00000000} \
   CONFIG.USER_REG_ADDR_MASK3 {0x00000000} \
   CONFIG.USER_REG_ADDR_MASK4 {0x00000000} \
   CONFIG.USER_REG_ADDR_MASK5 {0x00000000} \
   ...
   CONFIG.USER_REG_ADDR_MASK14 {0x00000000} \
   CONFIG.USER_REG_ADDR_MASK15 {0x00000000} \
   CONFIG.USER_REG_ADDR_REMAP {0x0003} \
   CONFIG.USER_REG_ADDR_RPADDR0 {0x02014000} \
   CONFIG.USER_REG_ADDR_RPADDR1 {0x0201c000} \
   CONFIG.USER_REG_ADDR_RPADDR2 {0x00000000} \
   CONFIG.USER_REG_ADDR_RPADDR3 {0x00000000} \
   CONFIG.USER_REG_ADDR_RPADDR4 {0x00000000} \
   CONFIG.USER_REG_ADDR_RPADDR5 {0x00000000} \
  ...
  connect_bd_intf_net -intf_net M02_AXI_nsu_MAXI4 [get_bd_intf_ports M02_AXI] [get_bd_intf_pins M02_AXI_nsu/MAXI4]
  ...
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_ports S01_AXI] [get_bd_intf_pins S01_AXI_rpu/SAXI4]
  ...
  # Create port connections
  connect_bd_net -net M00_AXI_nsw_NSU [get_bd_pins M00_AXI_nsu/NSU] [get_bd_pins hier_nsw/NSU1]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets M00_AXI_nsw_NSU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets M00_AXI_nsw_NSU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets M00_AXI_nsw_NSU]
  connect_bd_net -net M01_AXI_nsw_NSU [get_bd_pins M01_AXI_nsu/NSU] [get_bd_pins hier_nsw/NSU2]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets M01_AXI_nsw_NSU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets M01_AXI_nsw_NSU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets M01_AXI_nsw_NSU]
  connect_bd_net -net M02_AXI_nsw_NSU [get_bd_pins M02_AXI_nsu/NSU] [get_bd_pins hier_nsw/NSU3]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets M02_AXI_nsw_NSU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets M02_AXI_nsw_NSU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets M02_AXI_nsw_NSU]
  ...
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets MC0_nsw_NSU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets MC0_nsw_NSU]
  connect_bd_net -net S00_AXI_nmu_NMU [get_bd_pins S00_AXI_nmu/NMU] [get_bd_pins hier_nsw/NMU2]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets S00_AXI_nmu_NMU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets S00_AXI_nmu_NMU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets S00_AXI_nmu_NMU]
  connect_bd_net -net S01_AXI_rpu_NMU [get_bd_pins S01_AXI_rpu/NMU] [get_bd_pins hier_nsw/NMU4]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets S01_AXI_rpu_NMU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets S01_AXI_rpu_NMU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets S01_AXI_rpu_NMU]
  connect_bd_net -net S02_AXI_nmu_NMU [get_bd_pins S02_AXI_nmu/NMU] [get_bd_pins hier_nsw/NMU3]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets S02_AXI_nmu_NMU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets S02_AXI_nmu_NMU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets S02_AXI_nmu_NMU]
  ...
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets S03_AXI_nmu_NMU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets S03_AXI_nmu_NMU]
  connect_bd_net -net S04_AXI_nmu_NMU [get_bd_pins S04_AXI_nmu/NMU] [get_bd_pins hier_nsw/NMU1]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets S04_AXI_nmu_NMU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets S04_AXI_nmu_NMU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets S04_AXI_nmu_NMU]
  connect_bd_net -net S05_AXI_nmu_NMU [get_bd_pins S05_AXI_nmu/NMU] [get_bd_pins hier_nsw/NMU]
  set_property HDL_ATTRIBUTE.DONT_TOUCH {true} [get_bd_nets S05_AXI_nmu_NMU]
  set_property HDL_ATTRIBUTE.SYNTH_ONLY {true} [get_bd_nets S05_AXI_nmu_NMU]
  set_property HDL_ATTRIBUTE.NOC.IS_NOC_NET {true} [get_bd_nets S05_AXI_nmu_NMU]
  connect_bd_net -net aclk0_1 [get_bd_ports aclk0] [get_bd_pins S00_AXI_nmu/aclk]
  connect_bd_net -net aclk1_1 [get_bd_ports aclk1] [get_bd_pins S01_AXI_rpu/aclk]
  ...
  connect_bd_net -net m02_axi_nsu_if_noc_npp_in_noc_credit_rdy [get_bd_pins M02_AXI_nsu/IF_NOC_NPP_IN_NOC_CREDIT_RDY]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_credit_rdy]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_credit_rdy]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_credit_rdy]
  connect_bd_net -net m02_axi_nsu_if_noc_npp_in_noc_credit_return [get_bd_pins M02_AXI_nsu/IF_NOC_NPP_IN_NOC_CREDIT_RETURN]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_credit_return]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_credit_return]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_credit_return]
  connect_bd_net -net m02_axi_nsu_if_noc_npp_in_noc_flit [get_bd_pins M02_AXI_nsu/IF_NOC_NPP_IN_NOC_FLIT]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_flit]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_flit]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_flit]
  connect_bd_net -net m02_axi_nsu_if_noc_npp_in_noc_valid [get_bd_pins M02_AXI_nsu/IF_NOC_NPP_IN_NOC_VALID]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_valid]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_valid]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_in_noc_valid]
  connect_bd_net -net m02_axi_nsu_if_noc_npp_out_noc_credit_rdy [get_bd_pins M02_AXI_nsu/IF_NOC_NPP_OUT_NOC_CREDIT_RDY]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_credit_rdy]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_credit_rdy]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_credit_rdy]
  connect_bd_net -net m02_axi_nsu_if_noc_npp_out_noc_credit_return [get_bd_pins M02_AXI_nsu/IF_NOC_NPP_OUT_NOC_CREDIT_RETURN]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_credit_return]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_credit_return]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_credit_return]
  connect_bd_net -net m02_axi_nsu_if_noc_npp_out_noc_flit [get_bd_pins M02_AXI_nsu/IF_NOC_NPP_OUT_NOC_FLIT]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_flit]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_flit]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_flit]
  connect_bd_net -net m02_axi_nsu_if_noc_npp_out_noc_valid [get_bd_pins M02_AXI_nsu/IF_NOC_NPP_OUT_NOC_VALID]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_valid]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_valid]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets m02_axi_nsu_if_noc_npp_out_noc_valid]
  ...
  connect_bd_net -net s01_axi_rpu_if_noc_npp_in_noc_credit_rdy [get_bd_pins S01_AXI_rpu/IF_NOC_NPP_IN_NOC_CREDIT_RDY]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_credit_rdy]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_credit_rdy]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_credit_rdy]
  connect_bd_net -net s01_axi_rpu_if_noc_npp_in_noc_credit_return [get_bd_pins S01_AXI_rpu/IF_NOC_NPP_IN_NOC_CREDIT_RETURN]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_credit_return]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_credit_return]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_credit_return]
  connect_bd_net -net s01_axi_rpu_if_noc_npp_in_noc_flit [get_bd_pins S01_AXI_rpu/IF_NOC_NPP_IN_NOC_FLIT]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_flit]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_flit]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_flit]
  connect_bd_net -net s01_axi_rpu_if_noc_npp_in_noc_valid [get_bd_pins S01_AXI_rpu/IF_NOC_NPP_IN_NOC_VALID]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_valid]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_valid]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_in_noc_valid]
  connect_bd_net -net s01_axi_rpu_if_noc_npp_out_noc_credit_rdy [get_bd_pins S01_AXI_rpu/IF_NOC_NPP_OUT_NOC_CREDIT_RDY]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_credit_rdy]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_credit_rdy]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_credit_rdy]
  connect_bd_net -net s01_axi_rpu_if_noc_npp_out_noc_credit_return [get_bd_pins S01_AXI_rpu/IF_NOC_NPP_OUT_NOC_CREDIT_RETURN]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_credit_return]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_credit_return]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_credit_return]
  connect_bd_net -net s01_axi_rpu_if_noc_npp_out_noc_flit [get_bd_pins S01_AXI_rpu/IF_NOC_NPP_OUT_NOC_FLIT]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_flit]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_flit]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_flit]
  connect_bd_net -net s01_axi_rpu_if_noc_npp_out_noc_valid [get_bd_pins S01_AXI_rpu/IF_NOC_NPP_OUT_NOC_VALID]
  set_property HDL_ATTRIBUTE.SIM_ONLY {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_valid]
  set_property HDL_ATTRIBUTE.EXT_CONN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_valid]
  set_property HDL_ATTRIBUTE.HIDDEN {TRUE} [get_bd_nets s01_axi_rpu_if_noc_npp_out_noc_valid]
