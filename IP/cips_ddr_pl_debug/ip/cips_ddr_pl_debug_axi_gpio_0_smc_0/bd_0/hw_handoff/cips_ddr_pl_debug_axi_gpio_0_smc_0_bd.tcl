...
################################################################
# This is a generated script based on design: bd_ccac
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./cips_ddr_pl_debug/ip/cips_ddr_pl_debug_axi_gpio_0_smc_0/bd_0
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x00000201C0000000} \
   ...
   CONFIG.S_ARUSER_WIDTH {18} \
   CONFIG.S_AWUSER_WIDTH {18} \
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SC_ARUSER_WIDTH {18} \
   CONFIG.SC_AWUSER_WIDTH {18} \
