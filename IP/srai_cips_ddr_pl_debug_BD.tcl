...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_noc_0_M01_AXI] [get_bd_intf_pins axi_noc_0/M01_AXI] [get_bd_intf_pins axis_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net clk_wizard_0_clk_out1 [get_bd_ports CIPS_CLOCK_OUT_100M] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_dbg_hub_0/aclk] [get_bd_pins axi_noc_0/aclk6] [get_bd_pins axis_ila_0/clk] [get_bd_pins axis_vio_0/clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_wizard_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
